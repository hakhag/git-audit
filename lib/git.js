...
export function header(title, subtitle) {
  ...
  console.log(chalk.bold.cyan('│') + chalk.bold.white(` ${title}`.padEnd(width)) + chalk.bold.cyan('│'));
  if (subtitle) {
    console.log(chalk.bold.cyan('│') + chalk.dim(` ${subtitle}`.padEnd(width)) + chalk.bold.cyan('│'));
  }
  console.log(chalk.bold.cyan(`└${line}┘`));
}
