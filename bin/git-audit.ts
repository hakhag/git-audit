...
program
  ...
  .option(
    '--since <date>',
    'Lookback window for applicable commands',
    '1 year ago',
  )
...
if (process.argv.length === 2) {
  ...
  console.log()
  console.log(
    chalk.dim('  Options on any command: --since "6 months ago"  --top 10'),
  )
  console.log(
    chalk.dim('  Example: git-audit churn --since "6 months ago" --top 10'),
  )
  console.log()
  process.exit(0)
}
